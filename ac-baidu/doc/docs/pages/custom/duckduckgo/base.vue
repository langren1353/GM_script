<template>
  <div>
    <el-form :model="state" label-width="auto" style="max-width: 800px">
      ...
      <el-divider />
      <el-form-item for="nothing" label="鸭鸭护眼模式" label-position="left">
        <el-tooltip class="box-item" effect="dark" :hide-after=20 content="鸭鸭护眼模式，开启将会自动进行护眼优化，开启后会自动开启全局护眼模式" placement="top">
