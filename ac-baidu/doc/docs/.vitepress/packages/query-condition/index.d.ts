declare const TQueryCondition: ({
    new (...args: any[]): {
        ...
        $emit: (event: "reset" | "submit" | "handleEvent", ...args: any[]) => void;
        $el: any;
        ...
        }, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, ("reset" | "submit" | "handleEvent")[], string, {
            loading: boolean;
            reset: boolean;
            labelWidth: string;
    ...
    resetHandle: () => void;
    checkHandle: (flagText?: any) => void;
}, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, ("reset" | "submit" | "handleEvent")[], "reset" | "submit" | "handleEvent", {
    loading: boolean;
    reset: boolean;
    labelWidth: string;
    opts: Record<string, any>;
